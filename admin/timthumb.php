...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', $_CONF['path_images'] . '/documents/cache');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
