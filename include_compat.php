...
/**
 * Populate controller request keys that old 1.1.0 code assumes always exist.
 *
 * This is a compatibility safety net for PHP 7/8 undefined-index notices.
 * Individual save handlers must still validate their own required values.
 *
