...
/**
 * Return a request value normalized to an integer.
 *
 * @param array  $source  Request source array
 * @param string $key     Key to read
...
/**
 * Normalize Geeklog permission values supplied by a form.
 *
 * The helper accepts either the checkbox arrays generated by Geeklog forms or
 * already-normalized numeric values. Missing values receive the caller's
 * defaults, avoiding undefined-index notices on partial/forged requests.
 *
 * @param array $source   Request source array
 * @param array $defaults Optional numeric defaults
 * @return array Four numeric permission values
 */
